...
GitHub: \href{https://github.com/MeaningfulnessMediaGroup/MMG-Technical-Reports}{GitHub Repo}}}
...
\cfoot{
    \footnotesize Copyright \copyright\ 2026 Meaningfulness Media Group. \href{https://creativecommons.org/licenses/by/4.0/}{Licensed under CC BY 4.0} \\
...
\fancyhf{}
\fancyhead[L]{\footnotesize \texttt{MMG-TR-001}} % <--- Protocol ID in top left
...
% --- SECTION 3 (Revised with Epistemic Distinction) ---
\newpage
...
\fancyhf{}
\fancyhead[L]{\footnotesize \texttt{MMG-TR-001}} % <--- Protocol ID in top left
\fancyhead[R]{\footnotesize References}     % <--- Current Section in top right
\cfoot{
    \footnotesize Copyright \copyright\ 2026 Meaningfulness Media Group. \href{https://creativecommons.org/licenses/by/4.0/}{Licensed under CC BY 4.0} \\
    Page \thepage\ of \pageref{LastPage}
}
